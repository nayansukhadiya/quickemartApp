...
function ChatHistory() {
  ...
  return (
    <div className="chatHistory">
      {/* <div className="chatHistoryInner"> */}
        {chatArray.length === 0 ? (
          <p>No chat history available.</p>
        ) : (
          chatArray.map((item) => {
            ...
            if (item.author === "admin" && item.rapidRecipeArr?.length > 0) {
              return (
                <div className="adminMessage Message" key={item.id}>
                  ...
                  <div className="tailMessage rightSide"><svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M5 10.5C4.49857 13.5086 1.66667 16.3333 0 17C6.4 17 10.5 14.8333 11.5 13.5L16.5 15L16 0H5.5V2V4V4.5C5.5 5.5 5.5 7.5 5 10.5Z" fill="#fff"/>
</svg>
</div>
                </div>
              );
