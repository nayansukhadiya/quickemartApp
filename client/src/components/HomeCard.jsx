  ...
  const handleImageLoad = () => {
    ...
    if (imgElement) {
      fac
        ...
        .then((color) => {
          // Modify the alpha value to 0.3
          const rgbaWithAlpha = `rgba(${color.value[0]}, ${color.value[1]}, ${color.value[2]}, 0.3)`;
    ...
    >
      <Link title={name} to={`/detail?id=${ProIDSearch}`}>
        <div className="img-section">
          ...
          <img ref={imgRef} crossOrigin="anonymous" src={img} alt={name} onLoad={handleImageLoad} />
        </div>
              ...
              <div className="discountBox">
                <div className="discountBoxInner">
                  ...
                  <h4 className="discountText">
                    {percentageDifference(price, mrp)}% OFF
                  </h4>
                </div>
              </div>
            )}
