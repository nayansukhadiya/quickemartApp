...
const foodStyle = [
  ...
  },
  {
    title: "nonVeg",
    text: "Non Vegetarian",
    icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-beef"><circle cx="12.5" cy="8.5" r="2.5"/><path d="M12.5 2a6.5 6.5 0 0 0-6.22 4.6c-1.1 3.13-.78 3.9-3.18 6.08A3 3 0 0 0 5 18c4 0 8.4-1.8 11.4-4.3A6.5 6.5 0 0 0 12.5 2Z"/><path d="m18.5 6 2.19 4.5a6.48 6.48 0 0 1 .31 2 6.49 6.49 0 0 1-2.6 5.2C15.4 20.2 11 22 7 22a3 3 0 0 1-2.68-1.66L2.4 16.5"/></svg>`,
  },
  {
    title: "vegan",
    text: "Vegan",
  ...
  return (
    <div className="ChatPage">
      <div className="pageRes">
        <TextAnimation />
        <div className="boxImgGemini"><div>Your cart has been generated using</div> <div>our custom-trained <img src="https://raw.githubusercontent.com/haruiz/geminiplayground/main/images/logo.png"/> model</div></div>
        <div className="ChatSuggestCardSec">
          {suggestionArr.map((item, index) => (
            <div className="suggestedCard" key={index}>
              <div
        ...
        <div className="FoodStyleCardSec">
          {foodStyle.map((item) => (
            <button key={item.title} className={item.title}>
