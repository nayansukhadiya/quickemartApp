...
import DetailPageRelated from "../components/DetailPageRelated";
...
function ProDetailPage() {
  ...
  return (
    <>
        ...
        <div className="detail-section-product part-section">
          ...
          >
            ...
            <div className="nameSecBrand">
              ...
              <div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right"><path d="m9 18 6-6-6-6"/></svg></div>
            </div>
          </Link></div>
      ...
      <div className="bgDetailDifferent">
      <RelatedBrand category={product.sub_category} brandName={product.brand}/></div>
      <div className="bgDetailDifferent">
        <DetailPageRelated related_search_value={`similar?proId=${product.p_id}&subCategory=${product.sub_category}`} name={`similar product`}/>
      </div>
      <div className="bgDetailDifferent">
        <DetailPageRelated related_search_value={`brandSimilar?proId=${product.p_id}&brand=${product.brand}`} name={`More ${product.brand} product`}/>
      </div>
    </>
  );
}
...
// const relatedArr =[{
//   secName: "Similar Product",
//   path: `/similar?proId=${product.p_id}&subCategory=${product.subCategory}`
// },{
//   secName: `More ${product.brand} product`,
//   path: `/brandSimilar?proId=${product.p_id}&brand=${product.brand}`
// }
// ]